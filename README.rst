...
2. Clone the plugin
   ``bash   git clone https://github.com/luismayta/zsh-pipenv``\ bash
3. Edit your ``.zshrc`` and add
   ``plugins=( ... zsh-pipenv )`` to your list of
   plugins
...
1. Add ``antibody bundle luismayta/zsh-pipenv`` to your
   ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
   run ``antibody bundle luismayta/zsh-pipenv`` in a
   running zsh session.
3. Enjoy!
...
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-pipenv.svg
   :target: https://github.com/luismayta/zsh-pipenv/issues
